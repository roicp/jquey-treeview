...
$treeFileName = Join-Path $packageScriptsFolder "jquery-treeview-*.js" | Get-ChildItem -Exclude "*.min.js","*-vsdoc.js" | Split-Path -Leaf
$treeFileNameRegEx = "jquery-treeview-((?:\d+\.)?(?:\d+\.)?(?:\d+\.)?(?:\d+)?(?:(?:-\w*)*)).js"
$treeFileName -match $treeFileNameRegEx
$ver = $matches[1]
